...
public class ContestantsBenchServer {
    public static void main(String[] args) throws AlreadyBoundException {
        ...
        try {
            ...
            System.out.println("Excepção na geração do stub para os bancos: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        }
        System.out.println("O stub para os bancos foi gerado!");
        ...
        try {
            ...
            System.out.println("Excepção no registo dos bancos: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        } catch (AlreadyBoundException e) {
            System.out.println("Os bancos já estão registados: " + e.getMessage());
            e.printStackTrace();
            System.exit(1);
        }
        
        System.out.println("Os bancos foram registados!");
    }
}
